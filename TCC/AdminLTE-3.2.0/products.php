...
//Deletar produto
  if ( isset($_POST['DelSub']) ) {
    //deletar o produto
    $sql = "exec PRC_Delete_product $_POST[DelSub]";

    $stmt = sqlsrv_query($conn, $sql);
    if( $stmt === false) { echo 'falha ao Deletar o Produto'; }

    //inserir Log
    $sqlL = " insert into log.tmp_log (Client,action, calendar)
              values ($_SESSION[IdUser], 'delete product [$_POST[DelSub]]', 'product')";
      
    $stmt = sqlsrv_query($conn, $sqlL);
    if( $stmt === false) { echo 'falha ao deletar o produto Log'; }
...
//select dos produtos
  ...
  { $sql  = "SELECT * FROM VW_tableProduct";
    $stmt = sqlsrv_query($conn, $sql);

  }

  elseif  ( $_SESSION['TpUser'] == 'V' ) 
  { $sql  = "SELECT * FROM VW_tableProduct where Idclient = $_SESSION[IdUser]";
    $stmt = sqlsrv_query($conn, $sql);
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Gerenciar produtos</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            ...
            <table id="example1" class="table table-striped projects" style="width: 100%" > <!-- myTABLE -->
                ...
                <thead>
                    ...
                    <tr><!--class="text-center"-->
                        ...
                        <th style="width: 15%">                     Nome da Categoria  </th>
                        <th style="width: 20%" class="text-center"> Imagem             </th>
                        <th style="width: 15%">                     Data Registrado    </th>
                        <th style="width: 15%">                     Usuario Criador    </th>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="text-center"><li class="list-inline-item"><img alt="Avatar" class="table-avatar" src="../<?php echo $row[3]; ?>"></li></td>
                    <td><?php echo $row[4]; ?></td>
                    <td><?php echo $row[5]; ?></td>
                    <td class="project-actions text-left"><form method="post">

                    <a class="btn btn-info btn-sm" href="./products-edit.php?IdPrd=<?php echo $row[1]; ?>"><i class="fas fa-pencil-alt"></i>  Edit</a>          
                    <button class="btn btn-danger btn-sm" name="DelSub" value="<?php echo $row[1]; ?>"><i class="fas fa-trash"></i>  Delete</button>
