...
//cadastrando uma categoria
  if(isset($_POST['Sub'])){
    ...
    $nameI = $_POST['Ncategory'];
        
    //inserir categoria
    $sql = "exec PRC_Insert_Category '$nameI', $_SESSION[IdUser]";
    
    $stmt = sqlsrv_query($conn, $sql);
    if( $stmt === false) { echo 'falha ao cadastrar Categoria'; }


    //inserir Log
    $sqlL = " insert into log.tmp_log (Client,action, calendar)
              values ($_SESSION[IdUser], 'insert Category [$nameI]', 'Category')";
              ...
              <div class="card-body">
                <form method="post">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Nome" name="Ncategory" >
                  </div>
