...
//Deletar categoria
  if ( isset($_POST['DelSub'] )) {
    //deletar a categoria
    $sql = "exec PRC_Delete_category $_POST[DelSub]";

    $stmt = sqlsrv_query($conn, $sql);
    if( $stmt === false) { echo 'falha ao Deletar a Categoria'; }

    //inserir Log
    $sqlL = " insert into log.tmp_log (Client,action, calendar)
              values ($_SESSION[IdUser], 'delete Category [$_POST[DelSub]]', 'Category')";
      
    $stmt = sqlsrv_query($conn, $sqlL);
    if( $stmt === false) { echo 'falha ao deletar a categoria Log'; }
...
//select da categoria
  ...
  { $sql  = "SELECT * FROM VW_TableCategory";
    $stmt = sqlsrv_query($conn, $sql);

  }

  elseif  ( $_SESSION['TpUser'] == 'V' ) 
  { $sql  = "SELECT * FROM VW_TableCategory where Idclient = $_SESSION[IdUser]";
    $stmt = sqlsrv_query($conn, $sql);
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card-body" class="card-body" style="margin: 0%; padding: 0%" >
          <table  id="example1" class="table table-striped projects"> <!-- myTABLE -->
              ...
              <thead>
                  ...
                  <tr><!--class="text-center"-->
                      ...
                      <th style="width: 20%">Data Registrado    </th>
                      <th style="width: 20%">Usuario Criador    </th>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="project-actions text-left"><form method="post">
                    ...
                    <a class="btn btn-info btn-sm" href="./Category-edit.php?IdCat=<?php echo $row[1]; ?>"><i class="fas fa-pencil-alt"></i>  Edit</a>          
