  ...
  if(isset($_POST['Sub'])){
    ...
    if( $_FILES['file']['name'] ){//Verificando se tem imagem
      if ( substr($_FILES['file']['type'],0,5) == 'image' ) {//Verificando se o tipo do arquivo é uma imagem
        ...
        $imgI="image/user/".$_FILES['file']['name'];


        //inserir usuario
        $sqlU = " insert Client (name, Login, Pass, Img, Type) 
                    values ('$nameI','$user','$pass','$imgI','$type')";
...
<head>
  ...
  <title>User Profile Adm Add</title>
                ...
                <form method="post" enctype="multipart/form-data">
                  ...
                  <label for="exampleInputEmail1">Tipo</label>
                    <div class="form-check">
                      ...
                      <input class="form-check-input" type="radio" name="type" value="V">
                      <label class="form-check-label">Vendedor</label>

                      <br>
                    
                      <input class="form-check-input" type="radio" name="type" value="U">
