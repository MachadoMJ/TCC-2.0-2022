...
//Table User  
  $sql = "SELECT * FROM VW_Adm_tableUser";
  $stmt = sqlsrv_query($conn, $sql);
          ...
          <table id="example1" class="table table-striped projects" style="width: 100%" > <!-- myTABLE -->
              ...
              <thead>
                  ...
                  <tr><!--class="text-center"-->
                      <th style="width: 1%" >                     #                  </th>
                      <th style="width: 15%">                     Nome do Usuario    </th>
                      <th style="width: 15%">                     Nome do Login      </th>
              ...
              <tbody>
                  ...
                  <tr>
                      ...
                      <td class="text-center"><li class="list-inline-item"><img alt="Avatar" class="table-avatar" src="../../../<?php echo $row[2]; ?>"></li></td>
                      <td> <?php echo $row[3]; ?> </td>
                      <td> <?php echo $row[4]; ?> </td>
                      <td class="project-actions text-left"><form method="post">

                          <a class="btn btn-info btn-sm" href="./profile-adm-edit.php?IdUser=<?php echo $row[5]; ?>"><i class="fas fa-pencil-alt"></i>  Edit</a>          
                          <button class="btn btn-danger btn-sm" name="DelSub" value="<?php echo $row[5]; ?>"><i class="fas fa-trash"></i>  Delete</button>
