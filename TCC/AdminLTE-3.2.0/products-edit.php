  ...
  if(isset($_POST['sub'])){
    ...
    if( $_FILES['file']['name'] ){//Verificando se tem imagem
      if ( substr($_FILES['file']['type'],0,5) == 'image' ) {//Verificando se o tipo do arquivo é uma imagem
        ...
        $_FILES['file']['name'] = $nameU . $category . '.' . substr($_FILES['file']['type'],6,null); //renomenado o arquivo

        move_uploaded_file($_FILES['file']['tmp_name'], "../image/Product/".$_FILES['file']['name']);
        $imgU="image/Product/".$_FILES['file']['name'];


        //atualizar usuario
        $sqlU = "exec PRC_Update_product '$nameU', $category, '$imgU', $price, '$desc', $id ";
        ...
        $sqlL = " insert into log.tmp_log (Client,action, calendar)
                    values ($_SESSION[IdUser], 'Update in product [$id] ', 'product')";
...
//Nome e Foto  
  $sqlV = "SELECT * FROM VW_update_product where id = $id";
  $stmtV = sqlsrv_query($conn, $sqlV);

  if(sqlsrv_fetch( $stmtV )) {

    $nameP = sqlsrv_get_field( $stmtV, 0); //nome do produto
    $desc  = sqlsrv_get_field( $stmtV, 1); //descrição
    $price  = sqlsrv_get_field( $stmtV, 2); //preco
  }
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Atualizar Produtos</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
              ...
              <div class="card-body">
                <form method="post" enctype="multipart/form-data" id="EditProduct">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="<?php echo $nameP; ?>" name="name">
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <textarea class="form-control" maxlength="100" placeholder="<?php echo $desc; ?>" form="EditProduct" name="desc"></textarea>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" min="1" step="any" class="form-control" placeholder="<?php echo $price; ?>" name="price">
                  </div>
